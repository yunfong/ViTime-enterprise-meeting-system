        ...
        <div class="col left">
            ...
            <div class="colBox">
                ...
                <?php foreach($all_user_list as $user):?>
                	<span title="<?php echo (!empty($user['name'])?$user['name']:$user['username'])?>"><input type="checkbox" id='ck-<?php echo $user['id']?>' value='<?php echo $user['id']?>'/><label><?php echo mb_substr((!empty($user['name'])?$user['name']:$user['username']),0,12,'utf8');?></label></span>
                <?php endforeach;?>    
        ...
        <div class="col right">
            ...
            <div class="colBox" >
                ...
                <?php foreach($user_list as $auser):?>
                	<span title="<?php echo (!empty($auser['name'])?$auser['name']:$auser['username'])?>"><input type="checkbox" id='sck-<?php echo $auser['id']?>' value='<?php echo $auser['id']?>' /><label><?php echo mb_substr((!empty($auser['name'])?$auser['name']:$auser['username']),0,12,'utf8');?></label></span>
                <?php endforeach;?>    
                    <div class="clearfix"></div>
                </div>
            </div>
