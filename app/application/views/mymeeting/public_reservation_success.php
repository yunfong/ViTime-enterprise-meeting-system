...
<div class="sysTipOk">
    ...
    <div class="regBot">
     ...
     <table cellspacing="0" cellpadding="20"  height="400" width="100%" style='font-family: serif sans-serif arial 微软雅黑;'>
     	<tr><td align='right' width='60'>收件人：</td><td align='left'>（多个帐号使用<strong>分号<font color='red'>;</font></strong>分隔，如 abc@163.com;you@qq.com）</td></tr>
		<tr><td align='right' width='60'>&nbsp;</td><td><textarea name='receipt'  rows='3' style='width:100%;font-family: serif sans-serif arial 微软雅黑;'></textarea></td></tr>
