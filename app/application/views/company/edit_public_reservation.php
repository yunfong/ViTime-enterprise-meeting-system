...
<div class="reserBox">
    	<div class="col">
            <h3>安排会议</h3>
            <div class="colBox">
                <form id="reserForm" name="reserForm" method='post' action='/company/do_edit_public_reservation' onsubmit="return do_open_public_meeting(this)">
    ...
    <div class="reserBtn">
        ...
        <button type="button" class="btn btnRed" onclick='window.location.href="/company/public_meeting"'>取消</button>
    </div>
