...
<?php $nav = ($login_user->isCmpAdmin()?'/company/cmp_admin_nav.php':($login_user->isCmpUser()?'/mymeeting/cmp_user_nav.php':'/tourist/nav.php'))?>
...
<div class="reserBox">
    	<div class="col">
            <h3>进入一场会议</h3>
            <div class="colBox">
                <form id="reserForm" name="reserForm" method='post'>
